...
//
// v3(2026-08-16): 4시간 간격 4편 → 8시간 간격 2편.
//   08시 / 16시. 8시간을 지키면서 둘 다 사람이 읽는 시간대에 두려면 이 둘뿐이다
//   (00시를 넣으면 3편이 되지만 새벽 발행은 노출을 못 받는다).
//   편수가 줄면 어뷰징 판정 위험도 낮아지고 소재 풀도 두 배 오래 간다.
//
