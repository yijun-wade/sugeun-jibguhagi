...
export function getVerdict(tag, priceLabel) {
  const map = {
    ...
    '교육환경': {
      '비쌈':  '초등학교·학원가 인프라가 가격에 반영됨',
      '적정':  '교육 환경 좋고 가격도 합리적, 자녀 교육에 유리',
      '저렴':  '교육 인프라 대비 저평가, 학군 수요 기대 가능',
    },
    '대학가': {
      '비쌈':  '대학가 수요로 임대·거주 수요 탄탄, 가격 부담 있음',
      '적정':  '대학가 인프라 갖추고 가격도 합리적',
      '저렴':  '대학가 인근에 가격까지 저렴, 실거주·임대 모두 유리',
    },
  }
