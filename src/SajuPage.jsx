...
// 일간 → hero 배경 키 (saju-hero-{key}.png 매칭)
const HERO_KEY_MAP = { '甲':'mok','乙':'mok','丙':'hwa','丁':'hwa','戊':'to','己':'to','庚':'geum','辛':'geum','壬':'su','癸':'su' }
function heroKey(ilgan) {
  if (!ilgan) return 'su'
  return HERO_KEY_MAP[ilgan[0]] || 'su'
}
